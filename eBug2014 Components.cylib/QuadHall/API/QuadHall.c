...
void `$INSTANCE_NAME`_Start()
{
	...
	*(reg8*)`$INSTANCE_NAME`_DAC_Seq_dp__D0_REG=0;
}
...
void `$INSTANCE_NAME`_SetOffsets(uint16 X1,uint16 Y1,uint16 X2,uint16 Y2)
{
	...
	while(*(reg8*)`$INSTANCE_NAME`_Hall_Select_dp_dp__A0_REG!=0x88);
	*(reg16*)`$INSTANCE_NAME`_DAC_Seq_dp__A0_A1_REG=X1;
	while(*(reg8*)`$INSTANCE_NAME`_Hall_Select_dp_dp__A0_REG!=0x11);
	*(reg16*)`$INSTANCE_NAME`_DAC_Seq_dp__A0_A1_REG=Y1;
	while(*(reg8*)`$INSTANCE_NAME`_Hall_Select_dp_dp__A0_REG!=0x22);
	*(reg16*)`$INSTANCE_NAME`_DAC_Seq_dp__A0_A1_REG=X2;
	while(*(reg8*)`$INSTANCE_NAME`_Hall_Select_dp_dp__A0_REG!=0x44);
	*(reg16*)`$INSTANCE_NAME`_DAC_Seq_dp__A0_A1_REG=Y2;
}
